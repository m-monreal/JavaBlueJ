package pruebaCreacionVentanaDDR;
...
public class EjemploWindowsBuilder extends JFrame {
    ...
    public EjemploWindowsBuilder() {
        ...
        spinner.setBounds(371, 20, 50, 20);
        ...
        list.setBounds(371, 72, 250, 80);
        contentPane.add(list);

        //Scroll asociado a la lista
        JScrollPane scroll2 = new JScrollPane(list); //Objeto
        scroll2.setBounds(371, 72, 250, 80); //Misma coordenadas y tamaño que el objeto
